...
const ContactForm = ({ contactForm, consistentLayout }) => {
  ...
  return (
    <section
      id="contact"
      className="bg-c1-0 responsivePad p font-dm-sans text-c4-0 py-8 2xl:py-12"
    ...
    >
      <div className="grid grid-cols-2 max-md:grid-cols-1 max-md:space-y-8">
        ...
        <div className="space-y-4 lg:space-y-8 flex flex-col justify-between 2xl:w-[115%]">
          ...
          <h2 className={`${consistentLayout.sectionSubheadingClass}`} style={{ marginBottom: '1rem' }}>
            {subheading}
          </h2>
        ...
        <div className="p-8 bg-c2-0 rounded-xl space-y-4 flex flex-col justify-around max-md:p-6 2xl:w-[75%] ml-auto 2xl:p-10">
          ...
          >
            ...
            {/* Submit Button */}
            <div className="turnParent flex p-2 rounded-lg bg-c1-0 px-4 border-c4-0 border-2 w-fit items-center space-x-1 text-base transition-all hover:bg-c3-0 hover:px-8">
              <button
                type="submit"
